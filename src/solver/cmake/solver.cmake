...
if (MSVC)
	...
	if (USE_SIRIUS)
		target_link_libraries(libmodel_antares PUBLIC ${SIRIUSDIR}/lib/libbib_solveur.so)
		target_link_libraries(libmodel_antares-swap PUBLIC ${SIRIUSDIR}/lib/libbib_solveur.so)
	endif()
endif()
